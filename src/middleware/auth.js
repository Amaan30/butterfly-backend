...
var authMiddleware = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, decoded, user, err_1, errorMessage;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, user_1.default.findById(decoded._id).select('-password')];
            case 2:
                user = _a.sent();
                if (!user) {
            ...
            case 3:
                err_1 = _a.sent();
                errorMessage = err_1 instanceof Error ? err_1.message : 'Invalid token';
